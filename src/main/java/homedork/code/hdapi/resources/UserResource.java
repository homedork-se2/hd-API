...
public class UserResource {
     ...
     */
    @POST
    @Path("/add/{userId}/{name}/{email}")
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public User addNewUser(@PathParam("userId") String userId, @PathParam("name") String name, @PathParam("email") String email) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public Device removeDevice(@PathParam("userId") String userId, @PathParam("deviceId") String deviceId) {
        System.out.println("REMOVE USER'S DEVICE");
